...
const config = {
  "generator": {
    ...
    "output": {
      "value": "D:\\gs\\users\\src\\datasources\\prisma-clients\\users",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
    ...
    "sourceFilePath": "D:\\gs\\users\\src\\datasources\\users.prisma",
    "isCustomOutput": true
  },
  "relativeEnvPaths": {
    "rootEnvPath": null,
...
if (!fs.existsSync(path.join(__dirname, 'schema.prisma'))) {
  const alternativePaths = [
    "src/datasources/prisma-clients/users",
    "datasources/prisma-clients/users",
  ]
...
path.join(process.cwd(), "src/datasources/prisma-clients/users/query_engine-windows.dll.node")
// file annotations for bundling tools to include these files
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "src/datasources/prisma-clients/users/schema.prisma")
