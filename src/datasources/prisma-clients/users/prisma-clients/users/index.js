...
const config = {
  "generator": {
    ...
    "output": {
      "value": "D:\\gs\\users\\src\\datasources\\prisma-clients\\users\\prisma-clients\\users",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
    ...
    "sourceFilePath": "D:\\gs\\users\\src\\datasources\\prisma-clients\\users\\schema.prisma",
    "isCustomOutput": true
  },
  "relativeEnvPaths": {
    "rootEnvPath": null,
  ...
  "inlineSchemaHash": "7e185e3b1b6afdad2c86ab6b0e6b505a31491ad24d8c08a3f11e527873fb2b15",
  "copyEngine": true
}
...
if (!fs.existsSync(path.join(__dirname, 'schema.prisma'))) {
  const alternativePaths = [
    "src/datasources/prisma-clients/users/prisma-clients/users",
    "datasources/prisma-clients/users/prisma-clients/users",
  ]
...
path.join(process.cwd(), "src/datasources/prisma-clients/users/prisma-clients/users/query_engine-windows.dll.node")
// file annotations for bundling tools to include these files
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "src/datasources/prisma-clients/users/prisma-clients/users/schema.prisma")
